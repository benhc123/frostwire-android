...
FrostWire for Android will let you search and download files from the [BitTorrent network](http://www.bittorrent.com/) and several popular cloud services and it will let you share files with other FrostWire for Android devices on the same local network (via WiFi).
